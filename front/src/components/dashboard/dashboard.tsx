...
export default function Dashboard() {
  ...
  const handleAction = async (action: "add" | "update" | "delete") => {
      ...
      case "Products":
        return (
          <ProductForm
            ...
            setFormData={
              setFormData as React.Dispatch<React.SetStateAction<ProductItem>>
            }
      ...
      case "Customers":
        return (
          <CustomerForm
            ...
            setFormData={
              setFormData as React.Dispatch<React.SetStateAction<CustomerItem>>
            }
            formErrors={formErrors}
          />
        );
      case "Orders":
        return (
          <OrderForm
            ...
            setFormData={
              setFormData as React.Dispatch<React.SetStateAction<OrderItem>>
            }
            formErrors={formErrors}
          />
        );
          ...
          <SupplyChainForm
            ...
            setFormData={
              setFormData as React.Dispatch<
                React.SetStateAction<SupplyChainItem>
              >
            }
            formErrors={formErrors}
          />
      ...
      case "Promotions":
        return (
          <PromotionForm
            ...
            setFormData={
              setFormData as React.Dispatch<React.SetStateAction<PromotionItem>>
            }
            formErrors={formErrors}
          />
        );
